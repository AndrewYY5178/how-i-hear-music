...
const sourceFiles = ['index.html', '404.html', 'terms.html', 'base.js', 'app.js', 'sw.js', 'modules/home.js', 'modules/layout/i18n.js', 'modules/layout/shell.js', 'modules/archive/pages.js', 'modules/archive/compilations.js', 'modules/rating/pages.js', 'modules/taste/pages.js', 'modules/import/pages.js', 'modules/journal/pages.js', 'modules/search/pages.js', 'modules/music/api.js', 'modules/music/cloud-sync.js', 'modules/music/cover-maintenance.js', 'modules/music/sync.js', 'modules/music/album-import.js', 'modules/music/versions.js', 'modules/music/insights.js', 'modules/music/sonic.js', 'modules/music/album-narrative.js', 'modules/music/analysis.js', 'modules/music/groups.js', 'modules/music/portrait.js', 'modules/music/taste-dna.js', 'modules/music/entropy.js', 'modules/music/memory.js', 'modules/music/geometry.js'];
...
const snapshotRoutes = ['/archive', '/archive/tracks', '/archive/albums', '/archive/artists', '/archive/compilations', '/rate', '/taste', '/taste/journal', '/import', '/journal'];
...
const albumFieldSource = await readFile(join(root, 'modules', 'layout', 'album-wave-canvas.js'), 'utf8');
if (!albumFieldSource.includes('introDuration') || !albumFieldSource.includes('album-detail-image') || !albumFieldSource.includes('currentRadius')) errors.push('album color field: album-centered expansion transition is missing');
