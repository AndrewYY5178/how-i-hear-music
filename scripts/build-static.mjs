...
const routes = [
  ...
  { path: '/archive/compilations', title: 'Archive — Custom compilation', description: 'Choose works, arrange a private compilation and design its cover locally.', body: pageHeader('Custom compilation', 'Choose works, arrange the order, and design your cover. Enable JavaScript to open the editor.') },
  ...
  { path: '/taste/journal', title: 'Taste — Journal', description: 'Recent changes, rediscoveries and annual listening evidence inside the Taste archive.', body: pageHeader('Listening, over time.', 'Recent changes, rediscoveries and annual summaries remain part of the Taste archive.') },
