...
assert.match(mergedTaste, /class="essay-item-toggle"[^>]*>\+<\/span>/);
assert.doesNotMatch(mergedTaste, /<details class="essay-item" open/);
assert.match(stylesheet, /\.essay-stack details>summary \{ display:grid;/);
