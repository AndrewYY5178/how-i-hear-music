...
- Use the repository spacing scale: 8 / 16 / 24 / 40 / 64 / 96 / 144px.
- Keep album artwork in 1:1 frames; keep catalog metadata in a fixed order.
- Preserve `#e7dfcf` paper, `#20201d` ink, `#a44733` red, and the olive Rate studio rather than importing reference-site colors.
- Use Libre Baskerville for display/body and DM Mono for navigation/metadata.
- Use 0 radius and no shadow by default.
