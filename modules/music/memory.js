import { accountSignedIn, allTracks, storage, trackId, visibleJournal } from "./data.js?v=0.9.110";
...
export const readMemoryEntries = () => accountSignedIn() ? storage.get(memoryStorageKey, []) : [];
