import { allAlbums, allArtists, allTracks, canonical, data, slug, storage, trackId } from "./data.js?v=0.9.112";
...
export const storeAlbumImport = (album, sourceUrl) => {
  ...
  const record = {
    ...
    coverUrl: album.coverUrl || album.artworkUrl || null,
    coverSource: album.coverUrl || album.artworkUrl ? "QQ Music public album artwork" : null,
    status: "IMPORTED",
    sourceUrl,
