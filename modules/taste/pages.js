import { allArtists, allTracks, archiveVisibleAlbums, data, findTrack, rating, safe, storage, trackId, visibleJournal, visibleRatings } from "../music/data.js?v=0.9.115";
