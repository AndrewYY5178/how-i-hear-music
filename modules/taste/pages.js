import { allArtists, allTracks, archiveVisibleAlbums, data, findTrack, rating, safe, storage, trackId, visibleJournal, visibleRatings } from "../music/data.js?v=0.9.102";
...
const mergedTasteSections = [
  ...
  ["INSIGHTS", "Transparent analysis of the boundaries, movement and gaps in your listening.", [["SONIC MAP", "/taste/sonic-map"], ["BOUNDARIES", "/taste/anti-recommendation"], ["MEMORY PALACE", "/taste/journal/memory-palace"], ["ARCHIVE ENTROPY", "/taste/journal/entropy"], ["TASTE CONSTELLATION", "/taste/family-tree"]]],
];
