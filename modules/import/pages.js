...
export const importQQ = () => `${pageHeader("IMPORT / QQ MUSIC", "Bring a QQ record in.", "Public metadata only: no QQ login, Cookie, audio or lyrics.")}${importNav()}<section class="import-workspace"><form id="qq-import-form"><label><span class="mono">PASTE PLAYLIST / SHARE CARD</span><textarea id="qq-share" rows="4" placeholder="Paste QQ Music playlist share text or link"></textarea></label><button class="button primary" type="submit">PREVIEW IMPORT</button></form><aside id="qq-import-result"><span class="mono">IMPORT PREVIEW</span><h2>Bring a playlist to the desk.</h2><p>Paste a public QQ Music playlist link to begin.</p></aside></section><section class="catalog-search"><span class="eyebrow mono">QQ MUSIC CATALOG</span><form id="qq-search-form"><input id="qq-search-query" type="search" placeholder="Search tracks, artists or albums"><button class="button" type="submit">SEARCH QQ MUSIC</button></form><div id="qq-search-results"></div></section>`;
