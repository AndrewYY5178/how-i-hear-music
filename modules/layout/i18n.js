...
const zh = {
  ...
  "Tracks": "单曲", "Albums": "专辑", "Artists": "艺人", "Metadata": "资料", "Profile": "画像", "Philosophy": "理念", "Compare": "对比", "PRODUCTION": "制作", "COVER UNAVAILABLE": "封面暂不可用", "No confirmed track scores yet.": "还没有确认的曲目评分。", "No confirmed ordered track sequence is available yet.": "还没有可用的已确认曲序。", "A neutral landscape description appears after every track has a confirmed Overall score.": "每首歌都确认总体评分后，这里会出现专辑地形描述。", "A cover, artist, and overall response.": "一张封面、一位艺人与一次总体感受。", "No confirmed albums recorded.": "还没有确认的专辑记录。", "No scored tracks recorded yet.": "还没有已评分的单曲记录。",
  ...
  "READ THE METHOD ↓": "看看我怎么听 ↓", "CURRENTLY LISTENING": "此刻在听", "Open": "打开", "Previous record": "上一张唱片", "Next record": "下一张唱片", "PREV": "上一张", "NEXT": "下一张", "Complete the shape.": "先完成这份形状。", "Song, Vocal, Production and Overall must all be rated before a track appears here.": "只有 Song、Vocal、Production 和 Overall 都完成评分，这首歌才会出现在这里。",
  ...
  "No explicit listening reasons have been saved yet.": "还没有记下喜欢它的具体原因。", "No confirmed timestamped moments have been recorded yet.": "还没有记下某个确切的音乐瞬间。", "No local rating changes recorded yet.": "这首歌的评分还没有发生过变化。", "No alternate recording has been confirmed. Add one only when its identity is known.": "还没有确认其他录音版本；只有身份明确时才添加。", "FROM": "从", "TO": "到", "PLAY MORPH": "播放变化", "CONFIRM ANOTHER RECORDING": "确认另一个录音版本", "IDENTIFYING LABEL": "识别标签", "ADD VERSION": "添加版本", "Stored locally. Nothing is inferred from the title.": "已保存在本地；不会根据标题猜测任何内容。", "Character only—neither side is better.": "这里只描述声音性格，不代表哪一边更好。", "SAVE SONIC CHARACTER": "保存声音性格", "No sonic character saved yet.": "还没有保存声音性格。", "Saved locally.": "已保存在本地。",
  ...
  "FIND LANGUAGE + REGION": "查找语言与地区", "MusicBrainz candidates describe a release's market and title/track-title language, not lyric language.": "MusicBrainz 候选描述的是发行地区及专辑、曲目标题语言，不是歌词语言。", "Searching public MusicBrainz release metadata…": "正在查找 MusicBrainz 公开发行资料……", "No public MusicBrainz release candidates found.": "没有找到 MusicBrainz 公开发行候选。", "MUSICBRAINZ RELEASE CANDIDATE": "MUSICBRAINZ 发行候选", "USE LANGUAGE + REGION": "采用语言与地区", "OPEN MUSICBRAINZ ↗": "打开 MUSICBRAINZ ↗", "Language and region candidates copied. Review their release scope, then save field evidence.": "语言与地区候选已填入；请核对其发行版本范围后再保存字段证据。", "release title/track-title language (not lyrics)": "专辑、曲目标题语言（不是歌词语言）", "release country": "发行地区",
  ...
  "RATE / UNRATED QUEUE": "评分 / 待评分", "What have you heard but not rated?": "哪些歌已经听过，却还没有评分？", "Heard records lead; newly imported records remain visible underneath.": "听过但未评分的歌排在前面，新导入的歌留在后面。", "MARK HEARD": "标记为听过", "QUEUE CLEAR": "没有待评分歌曲", "No heard or imported track is waiting for a rating.": "目前没有听过或导入后尚未评分的歌。", "IMPORT MUSIC →": "导入音乐 →", "IMPORT MUSIC": "导入音乐",
  ...
  "QQ Playlist": "QQ 歌单", "QQ Album": "QQ 专辑", "QQ Music Smart Import": "QQ 音乐智能导入", "01 / QQ MUSIC": "01 / QQ 音乐", "NetEase": "网易云音乐", "Inbox": "收件箱", "Data Desk": "数据台",
  ...
  "QQ MUSIC SMART IMPORT": "QQ 音乐智能导入", "01 / QQ MUSIC SMART IMPORT": "01 / QQ 音乐智能导入", "Paste a public QQ Music playlist or album share. The desk identifies it first; nothing changes until you approve the relevant preview.": "粘贴公开的 QQ 音乐歌单或专辑分享内容。系统会先识别类型；你确认对应预览前，任何资料都不会改变。", "QQ MUSIC PLAYLIST OR ALBUM / SHARE TEXT": "QQ 音乐歌单或专辑 / 分享内容", "Paste a QQ Music playlist or album link, or the full share text": "粘贴 QQ 音乐歌单或专辑链接，或完整分享文字", "RECOGNIZE + PREVIEW": "识别并预览", "RECOGNIZING QQ MUSIC SHARE…": "正在识别 QQ 音乐分享……", "Resolving the public link before opening the right preview.": "正在解析公开链接，并打开相应的预览。", "Waiting for a public QQ Music playlist or album link.": "请先粘贴一个公开的 QQ 音乐歌单或专辑链接。", "Please paste a public QQ Music playlist or album link.": "请粘贴一个公开的 QQ 音乐歌单或专辑链接。", "Could not identify this QQ Music share.": "无法识别这条 QQ 音乐分享内容。", "Could not identify this as a public QQ Music playlist or album.": "这条内容不是可读取的 QQ 音乐公开歌单或专辑。", "Try another public QQ Music playlist or album link.": "请换一个公开的 QQ 音乐歌单或专辑链接。", "A playlist enters Inbox; a confirmed album import creates its ordered Archive record.": "歌单会进入收件箱；确认导入的专辑会以原始曲序写入档案。", "Paste one public QQ Music share. The desk identifies its type before opening the appropriate review.": "粘贴一条公开的 QQ 音乐分享。系统会先识别类型，再打开对应的核对步骤。",
  ...
  "TASTE": "审美", "How I hear music.": "我的聆听方式。", "The listening method behind the archive.": "这份档案背后的聆听逻辑。", "One personal listening archive: its overview, history and transparent insights.": "一份属于你的聆听档案：总览、变化与透明分析。", "OVERVIEW": "总览", "INSIGHTS": "洞察", "RECENT CHANGES": "最近变化", "The shape of the archive, its method and its recurring signals.": "从档案的形状、聆听方法，到反复出现的偏好信号。", "The time layer: what changed, resurfaced and earned a place in memory.": "从时间里看见哪些感受改变了、重新浮现了，又有哪些最终留在记忆里。", "Transparent analysis of the boundaries, movement and gaps in your listening.": "用可以追溯的依据，分析聆听中的边界、变化与空白。", "Listening Philosophy": "我怎么听", "Good ≠ Mine": "好 ≠ 我会喜欢", "LISTENING PHILOSOPHY": "我的聆听观", "MY TASTE PROFILE": "我的审美画像", "GOOD ≠ MINE": "好 ≠ 我会喜欢", "COMPARE WITH ME": "和我一起听", "The parts that need a reason to exist.": "我在意什么，以及为什么。", "A visual summary, not a personality test.": "一张审美地图，不是一份性格测试。", "Respect and resonance are different things.": "认可一首歌，与被它打动，是两回事。", "Rate a track, then reveal the distance.": "给同一首歌评分，看看我们听见的差别。",
  "TASTE DNA": "审美 DNA", "LISTENING DNA": "聆听 DNA", "LISTENING JOURNAL": "聆听日志", "BLIND SPOTS": "审美盲区", "BOUNDARIES": "审美边界", "SONIC MAP": "声音地图", "TASTE CONSTELLATION": "审美星座", "LISTENING PORTRAIT": "聆听肖像",
  "TASTE / PHILOSOPHY": "审美 / 聆听观", "Every element needs a reason.": "每个声音，都得有留下的理由。", "Melody": "旋律", "Melody opens the door. Arrangement makes me stay. Details make me return.": "旋律让我走进来，编曲让我留下，细节让我一再回来。", "Surprise belongs to the song.": "真正的惊喜，应该长在歌里。", "The human voice stays human.": "人声不该失去人的痕迹。", "Obvious Auto-Tune or pitch correction replacing human presence: totally unacceptable.": "如果明显的自动修音或音高修正取代了真实的人声质感，我完全无法接受。",
  ...
  "TASTE / DNA": "审美 / DNA", "What repeats beneath the ratings.": "分数背后，反复出现的是什么？", "A trait needs at least five supporting tracks. Genre is not used as the primary explanation.": "一种审美基因至少要有五首歌共同支持；音乐类型不作为主要解释。", "HOW STRENGTH AND CONFIDENCE WORK": "怎么看强度与可信度", "combines the supporting tracks' average Overall, lift above your archive baseline and score consistency.": "综合支持歌曲的平均总分、高出档案基准的幅度，以及评分是否稳定。", "increases with evidence count, consistency and recency. Neither number predicts whether a new track will work.": "会随着证据数量、一致性和新近程度提高；两个数字都不会预测一首新歌是否会打动你。", "INSPECT EVIDENCE": "查看依据", "CONTRIBUTING TRACKS": "哪些歌支持了它", "LIMITING EVIDENCE / BELOW BASELINE": "相反证据 / 低于基准", "ADD LISTENING EVIDENCE →": "继续积累聆听记录 →",
  "TASTE / BLIND SPOTS": "审美 / 盲区", "Where the archive has barely looked.": "档案还没怎么去过的地方。", "These are coverage gaps beside recurring taste evidence—not promises about what you will like.": "这些是稳定偏好旁边尚未探索的空白，不是系统替你保证会喜欢。", "TRAIT BLIND SPOT": "审美特征盲区", "ALBUM BLIND SPOT": "专辑聆听盲区", "COVERAGE BLIND SPOT": "资料覆盖盲区", "SONIC COVERAGE GAP": "声音分布空白", "CURRENT EVIDENCE": "现有依据", "EXPLORED": "已经探索", "EVIDENCE SIGNAL": "依据来自", "TRAIT AFFINITY": "偏好关联",
  ...
  "TASTE / LISTENING PORTRAIT": "审美 / 聆听肖像", "The archive as a print.": "把档案印成一幅肖像。", "Track shapes and album landscapes become one sampled composition—not a dashboard.": "单曲形状和专辑地形被取样、叠合成一幅作品，而不是数据看板。", "MY LISTENING PORTRAIT": "我的聆听肖像", "Built only from saved geometry. Dense archives are sampled to keep the print legible.": "只使用已经保存的聆听几何；当档案较密集时会抽样，以保持画面清晰。", "9+ TRACKS": "9 分以上", "FAVORITES": "最爱", "ALL TIME": "全部年份",
  ...
  "LOCAL SOURCE LABEL": "本地来源名称", "Untitled playlist": "未命名歌单", "SAVE LABEL": "保存名称", "CHECK PLAYLIST UPDATES": "检查歌单更新", "CHECKING…": "正在检查……", "REMOVE SOURCE": "移除这个来源", "CONFIRM REMOVE": "确认移除", "Import a public playlist once to create a local sync source.": "导入一次公开歌单后，这里会建立一个可同步的本地来源。", "No imported records yet.": "收件箱里还没有导入记录。",
  ...
  "PRIVATE CLOUD SYNC": "私密云同步", "ACCOUNT SYNC": "账号同步", "Keep every device together.": "让每台设备保持同步。", "GitHub identifies one shared archive. Sign in once, then every signed-in device follows the same music data automatically.": "GitHub 用于识别同一份共享档案。登录一次后，所有已登录设备都会自动跟随同一份音乐资料。", "This archive now follows your GitHub account automatically. New ratings, notes, Inbox, Memory and local archive changes sync without another password.": "这份档案现在会自动跟随你的 GitHub 账号。新的评分、笔记、收件箱、音乐记忆和本地档案改动都无需额外密码即可同步。", "Automatic sync active ·": "自动同步中 ·", "Your first local change will create the shared archive.": "下一次本地改动会创建这份共享档案。", "Account sync will appear after the hosted service is connected.": "连接线上服务后，账号同步会显示在这里。", "Could not check account sync.": "无法检查账号同步状态。", "Could not start automatic sync.": "无法启动自动同步。", "Move only encrypted copies.": "只迁移加密副本。", "GitHub identifies you. Your ratings, notes, Inbox and Memory are encrypted in this browser with the sync password below before any upload. The Worker stores only ciphertext.": "GitHub 只用于识别你的账号。上传前，评分、笔记、收件箱和音乐记忆会在此浏览器用下方同步密码加密；Worker 只保存密文。", "SYNC PASSWORD": "同步密码", "The password you will use on every device": "你将在每台设备上使用的密码", "UPLOAD ENCRYPTED COPY": "上传加密副本", "DOWNLOAD + PREVIEW": "下载并预览", "SIGN OUT": "退出登录", "SIGN IN WITH GITHUB": "使用 GitHub 登录", "Cloud sync will appear after the hosted service is connected.": "连接线上服务后，私密云同步会显示在这里。", "CLOUD COPY PREVIEW": "云端副本预览", "WHEN THE SAME RECORD EXISTS": "同一记录已存在时", "KEEP LOCAL VALUES": "保留本地内容", "USE CLOUD VALUES": "采用云端内容", "CONFIRM MERGE": "确认合并", "No encrypted copy exists yet.": "还没有上传过加密副本。", "No encrypted copy uploaded yet.": "还没有上传过加密副本。", "Nothing has changed yet.": "此时尚未改动任何本地资料。", "Could not check cloud sync.": "无法检查云同步状态。", "Could not start GitHub sign-in.": "无法开始 GitHub 登录。", "Could not complete GitHub sign-in.": "无法完成 GitHub 登录。", "Could not upload the encrypted copy.": "无法上传加密副本。", "Could not download the encrypted copy.": "无法下载加密副本。", "Could not merge the encrypted copy.": "无法合并加密副本。",
...
Object.assign(zh, {
  ...
  "TO": "到",
  "PLAY MORPH": "播放变化",
  "CONFIRM ANOTHER RECORDING": "确认另一个录音版本",
  "IDENTIFYING LABEL": "识别标签",
  "ADD VERSION": "添加版本",
  "Stored locally. Nothing is inferred from the title.": "已保存在本地；不会根据标题猜测任何内容。",
  "Character only—neither side is better.": "这里只描述声音性格，不代表哪一边更好。",
  "SAVE SONIC CHARACTER": "保存声音性格",
  "No sonic character saved yet.": "还没有保存声音性格。",
  "Saved locally.": "已保存在本地。",
  "No confirmed albums recorded.": "还没有确认的专辑记录。",
  "No scored tracks recorded yet.": "还没有已评分的单曲记录。",
  "A cover, artist, and overall response.": "一张封面、一位艺人与一次总体感受。",
  "No confirmed track scores yet.": "还没有确认的曲目评分。",
  "No confirmed ordered track sequence is available yet.": "还没有可用的已确认曲序。",
  "A neutral landscape description appears after every track has a confirmed Overall score.": "每首歌都确认总体评分后，这里会出现专辑地形描述。",
  "COVER UNAVAILABLE": "封面暂不可用",
  "PRIVATE LISTENING NOTE": "私人聆听笔记",
  "CLEAR NOTE": "清除笔记",
  "Character": "声音性格",
  "HEARD": "已听过",
  "WAITING": "待处理",
  "VIEW QUEUE": "查看队列",
  "Bring in one track to begin a listening shape.": "先导入一首歌，开始画出聆听形状。",
  "No boundary repeats across three tracks yet. More explicit ratings may reveal a pattern; the site will not manufacture one.": "还没有在三首歌中重复出现的边界。更多明确评分可能会显出模式，但网站不会凭空制造模式。",
  "The archive as a print. Track shapes and album landscapes become one sampled composition—not a dashboard.": "把档案印成一张图。单曲形状与专辑地形汇成一幅取样构图，而不是仪表盘。",
  "THE LISTENING EDITION · ISSUE 001": "聆听特刊 · 第 001 期",
  "A personal archive of records, shapes and the reasons a song stays alive.": "一份关于唱片、形状，以及一首歌为何保持鲜活的私人档案。",
  "ANDDREAM / PRIVATE LISTENING ARCHIVE": "ANDDREAM / 私人聆听档案",
  "ONE SHEET / MANY WAYS OF LISTENING": "一张纸 / 许多种聆听方式",
  "FOCUS THE MASTHEAD · TURN THE PAGE": "聚焦报头 · 翻开这一页",
  "SKIP INTRO": "跳过开场",
  "Built only from saved geometry. Dense archives are sampled to keep the print legible.": "只根据已保存的几何生成；记录密集时会取样，以保持这张图清晰可读。",
  ...
  "REFRESH ALL COVER COLORS": "刷新全部封面色彩",
  "Cover palette refresh runs only in this browser and never uploads artwork.": "封面调色板刷新只在此浏览器中运行，不会上传任何封面。",
  "Re-reading cover colors…": "正在重新读取封面色彩……",
  "Refreshing cover colors…": "正在刷新封面色彩……",
  "Cover colors refreshed. The record and wave background now use the new palette.": "封面色彩已更新；胶片与波形背景现在使用新的调色板。",
  "Cover colors refreshed locally.": "封面色彩已在本机刷新。",
  "Could not re-extract the cover colors.": "无法重新提取封面色彩。",
  "cover palettes refreshed locally.": "张封面调色板已在本机刷新。",
  "A blind spot needs both stable taste evidence and a measurable coverage gap.": "审美盲区必须同时有稳定的偏好证据和可测量的资料缺口。",
  "ALBUM A": "专辑 A", "ALBUM B": "专辑 B", "ALBUM CHARACTER": "专辑性格", "ALBUM NOTES": "专辑笔记",
  "AVAILABLE:": "当前可用：", "COMPARE": "比较", "CONFIRM RESTORE": "确认恢复", "RESTORE PREVIEW": "恢复预览", "RESTORE": "恢复",
  "Comparing public metadata with the local archive.": "正在将公开资料与本地档案进行比较。",
  "LISTENING LANDSCAPE": "聆听地形", "LISTENING PROFILE": "聆听画像", "No albums are available for cover maintenance yet.": "暂时没有可维护封面的专辑。",
  "No recurring trait reaches five explicit tracks yet.": "还没有反复出现在五首明确评分歌曲中的特征。",
  "Plain and password-encrypted export, restore, recovery points and browser quota now live in one place.": "普通备份与加密备份、恢复记录和浏览器空间都集中在这里。",
  "RECURRING BOUNDARIES": "反复出现的边界", "Ratings can contribute to score-based traits. Why This Works, Listening Temperature and history make the model more specific.": "评分可以参与生成基于分数的特征；‘它为什么打动我’、声音性格和历史记录会让画像更具体。",
  "SAVE NOTE": "保存笔记", "Selected tracks": "选中的单曲", "Square images are cropped and compressed in this browser. They are never uploaded.": "方形图片会在此浏览器中裁切并压缩，绝不会上传。",
  "Theme color is sampled from the current cover.": "主题色取样自当前封面。", "USE BACKUP VALUES": "使用备份内容", "WHY THEY MATTER": "它们为什么重要",
  "MY LISTENING PORTRAIT": "我的聆听肖像", "listening portrait": "聆听肖像", "LISTENING SHAPE": "聆听形状",
  "IMPORT TRACK ORDER": "导入曲序", "THEME COLOR IS SAMPLED FROM THE CURRENT COVER.": "主题色取样自当前封面。",
  "LISTENING SHAPE / DRAWN FROM SAVED SCORES": "聆听形状 / 来自已保存的评分",
  "Vocal Interpretation": "人声诠释", "Production Curiosity": "制作敏感度",
  "No albums are available for cover maintenance yet.": "暂时没有可维护封面的专辑。",
  "No recurring trait reaches five explicit tracks yet.": "还没有反复出现在五首明确评分歌曲中的特征。",
  "THEME COLOR IS SAMPLED FROM THE CURRENT COVER.": "主题色取样自当前封面。",
  "CURRENT TRACKS": "当前单曲", "OF 5 DIMENSIONS AVAILABLE": "/ 5 个可用维度", "LATEST": "最近一次",
  "ALBUM OVERALL": "整张专辑评分", "TRACK-BY-TRACK": "逐曲评分", "BUILD THE LANDSCAPE": "画出专辑地形",
  "REVIEW QUEUE": "核对队列", "PUBLIC SOURCE CANDIDATES": "公开来源候选",
  "Track list": "曲目列表", "Selected tracks": "选中的单曲", "WHY THEY MATTER": "它们为什么重要", "RECURRING HERE": "反复出现于",
  "VOCAL INTERPRETATION": "人声诠释", "PRODUCTION CURIOSITY": "制作敏感度", "CORRECTED": "已修正",
  "No albums are available for cover maintenance yet.": "暂时没有可维护封面的专辑。",
  "No recurring trait reaches five explicit tracks yet.": "还没有反复出现在五首明确评分歌曲中的特征。",
  "Patterns describe recurring distance and coverage gaps, never a genre stereotype.": "这些模式描述反复出现的距离与资料缺口，从不把它归因于某种音乐类型。",
  "PLACED MANUALLY": "手动放置",
  "DERIVED FROM SAVED EVIDENCE": "来自已保存的证据",
  "Archive entropy over time": "档案熵随时间变化",
  "ARCHIVE / COMPILATIONS": "档案 / 自制专辑",
  "Custom albums": "自制专辑",
  "Custom compilation": "自制专辑",
  "Choose works, arrange the order, and design your cover.": "选择作品、编排曲序，并设计你的封面。",
  "Choose works, arrange the order, and design your cover. Enable JavaScript to open the editor.": "选择作品、编排曲序，并设计你的封面。请启用 JavaScript 进入编辑器。",
  "Back to albums": "返回专辑",
  "Loading local drafts…": "正在读取本地草稿……",
  "Could not confirm the account. Please sign in again.": "无法确认账户身份，请重新登录。",
  "Could not save the compilation.": "无法保存自制专辑。",
  "The account changed. Refresh the page.": "账户已切换，请刷新页面。",
  "The account changed. Reopen this page.": "账户已切换，请重新打开页面。",
  "Untitled compilation": "未命名专辑",
  "Night listening": "夜色留声",
  "Work unavailable": "作品已失效",
  "Remove or re-import it": "请移除或重新导入",
  "Custom compilation cover": "自制专辑封面",
  "Design your cover": "设计你的封面",
  "Guest showcase · isolated from your account": "游客演示 · 与个人账户隔离",
  "Private compilation": "私人编选",
  "Stored only in this browser · cloud sync is not enabled": "仅保存在此浏览器 · 暂不支持云同步",
  "Choose a saved compilation": "选择已存专辑",
  "New compilation": "新建专辑",
  "Delete current compilation": "删除当前专辑",
  "Choose tracks from the archive": "从档案选曲",
  "Search works": "搜索作品",
  ...
  "Design cover": "设计封面",
  "Album title": "专辑名称",
  "Compilation note": "编选说明",
  "Save draft": "保存草稿",
  "Preview album": "预览专辑",
  "Back to editing": "返回编排",
  "Cover studio": "封面工作室",
  "Cover preview": "封面预览",
  "Layout": "版式",
  "Single image": "单图",
  "Four-panel grid": "四格拼贴",
  "Text only": "纯文字",
  "Upload images (up to four)": "上传图片（最多四张）",
  "Title": "标题",
  "Text size": "字号",
  "Background": "背景",
  "Text color": "文字颜色",
  ...
  "Clear images": "清除图片",
  "Cancel": "取消",
  "Use this cover": "使用此封面",
  "Images are center-cropped; template editing is supported. Freeform layer arrangement is coming later.": "图片会居中裁切；当前支持模板编辑，自由图层编排将在后续开放。",
  "Up to four images.": "最多四张图片。",
  "Use JPEG, PNG or WebP files no larger than 10 MB.": "请使用不超过 10 MB 的 JPEG、PNG 或 WebP 文件。",
  "Image dimensions are too large.": "图片尺寸过大。",
  "Delete this custom compilation? Original works and ratings will not be deleted.": "删除这张自制专辑？原作品和评分不会被删除。",
  "Cover generation failed. Please try again.": "封面生成失败，请重试。",
  "Select at least one work first.": "请先选择至少一首作品。",
  "Draft saved in this browser.": "草稿已保存在此浏览器。",
});
...
const patterns = [
  ...
  [/^(\d+) RATED$/, (m) => `已评分 ${m[1]} 首`],
  [/^(\d+) ARCHIVED$/, (m) => `已归档 ${m[1]} 首`],
  [/^(\d+) TRACKS$/, (m) => `${m[1]} 首歌`],
  [/^AVG (.+) VS ARCHIVE (.+)$/, (m) => `平均 ${m[1]}，档案基准 ${m[2]}`],
  [/^(\d+)% CONFIDENCE$/, (m) => `可信度 ${m[1]}%`],
  [/^(SONG|VOCAL|PRODUCTION|OVERALL)$/, (m) => ({ SONG: "歌曲", VOCAL: "演唱", PRODUCTION: "制作", OVERALL: "总体" }[m[1]])],
  [/^(\d+) HEARD · (\d+) WAITING · VIEW QUEUE →$/, (m) => `已听过 ${m[1]} 首 · 待处理 ${m[2]} 首 · 查看队列 →`],
  [/^RATING (.+) · RELEASE (.+)$/, (m) => `评分 ${m[1]} · 发行 ${m[2]}`],
  [/^Taste trait strength (\d+) out of 100$/, (m) => `审美特征强度 ${m[1]} / 100`],
  [/^RECURRING BOUNDARIES (.+)$/, (m) => `反复出现的边界 · ${translateText(m[1], "zh-CN")}`],
  [/^RECURRING HERE · (.+)$/, (m) => `反复出现于 · ${m[1].split(" · ").map((part) => translateText(part, "zh-CN")).join(" · ")}`],
  [/^(.+) cover RATING (.+) · RELEASE (.+)$/, (m) => `${m[1]} 封面 · 评分 ${m[2]} · 发行 ${m[3]}`],
  [/^(.+) cover$/, (m) => `${m[1]} 封面`],
  [/^(.+) (listening glyph|signature)$/, (m) => `${m[1]} ${m[2] === "signature" ? "签名" : "聆听图形"}`],
  [/^(SONG|VOCAL|PRODUCTION|OVERALL) (.+) · (SONG|VOCAL|PRODUCTION|OVERALL) (.+) · (SONG|VOCAL|PRODUCTION|OVERALL) (.+) · (SONG|VOCAL|PRODUCTION|OVERALL) (.+)$/, (m) => `${translateText(m[1], "zh-CN")} ${m[2]} · ${translateText(m[3], "zh-CN")} ${m[4]} · ${translateText(m[5], "zh-CN")} ${m[6]} · ${translateText(m[7], "zh-CN")} ${m[8]}`],
  ...
  [/^Signed in as (.+)\.$/, (m) => `已登录为 ${m[1]}`],
  [/^Hello, (.+)\.$/, (m) => `你好，${m[1]}`],
  [/^Encrypted copy available · (.+)$/, (m) => `已有加密副本 · ${m[1]}`],
  [/^Automatic sync active · (.+)$/, (m) => `自动同步中 · ${m[1]}`],
  [/^SYNCED · (.+)$/, (m) => `已同步 · ${m[1]}`],
  [/^Encrypted copy uploaded · revision (\d+)\.$/, (m) => `加密副本已上传 · 版本 ${m[1]}`],
  [/^(\d+) groups · (\d+) conflicts$/, (m) => `${m[1]} 个数据组 · ${m[2]} 处冲突`],
  [/^(\d+) groups do not conflict with this browser\. Nothing has changed yet\.$/, (m) => `${m[1]} 个数据组与此浏览器没有冲突；目前尚未改动任何本地资料。`],
  [/^(\d+) local data groups merged\. A complete rollback is available below\.$/, (m) => `已合并 ${m[1]} 个本地数据组；下方可执行完整回滚。`],
  [/^(\d+) tracks entered Inbox\.$/, (m) => `${m[1]} 首歌已经进入收件箱。`],
  [/^CHECKING (\d+) TRACKS…$/, (m) => `正在核对 ${m[1]} 首曲目……`],
  ...
  [/^REDISCOVER · (\d+) MONTHS AGO$/, (m) => `重新听听 · ${m[1]} 个月前`],
  [/^(\d+) MOST RECENT$/, (m) => `最近 ${m[1]} 条`],
  [/^(\d{2}) \/ (.+) →$/, (m) => `${m[1]} / ${translateText(m[2], "zh-CN")} →`],
  [/^BLIND SPOT (\d+) · (.+)$/, (m) => `盲区 ${m[1]} · ${translateText(m[2], "zh-CN")}`],
  [/^(.+) beyond individual tracks$/, (m) => `${m[1]}：尚未深入整张专辑`],
  [/^(\d+) TRACK GLYPHS · (\d+) ALBUM TERRAINS · (\d+) ARTIST SIGNATURES$/, (m) => `${m[1]} 个单曲图形 · ${m[2]} 道专辑地形 · ${m[3]} 个艺人签名`],
