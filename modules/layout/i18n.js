...
const zh = {
  ...
  "RATING SAVED": "这次评分已保存", "Saved in this browser": "已保存在这个浏览器里。", "Saved in this browser.": "已保存在这个浏览器里。", "THEN": "当时", "NOW": "现在", "CHANGE": "变化", "VIEW TRACK": "回到这首歌", "BACK TO QUEUE": "返回待评分", "UNDO THIS SAVE": "撤销这次保存", "SAVE UNDONE": "已撤销这次保存", "The previous rating and lifecycle state were restored. The new Journal entry was removed.": "已经恢复保存前的评分和状态，并删除刚刚生成的日志记录。", "The prior Track ratings, album draft and Journal were restored.": "已经恢复先前的单曲评分、专辑草稿和日志记录。", "The album rating is incomplete.": "还有曲目没有完成评分。",
  ...
  "IMPORT / INBOX": "导入 / 收件箱", "Move music through the desk.": "让每首歌经过清楚的整理流程。", "Imported, heard and rated records stay out of Archive until you deliberately archive them.": "无论刚导入、已经听过还是已经评分，只有你亲自选择归档后，它们才会进入档案。", "IMPORTED": "刚导入", "HEARD": "听过", "ARCHIVED": "已归档", "PLAYLIST SOURCES": "歌单来源", "Check what changed.": "看看歌单发生了什么变化。", "Sync compares public snapshots. A removal never deletes a local track, rating or note.": "同步只对比两次公开快照。即使歌曲从原歌单移除，本地歌曲、评分和笔记也不会被删除。", "LOCAL DATA": "本地资料", "Keep the desk recoverable.": "给这些资料留一份退路。", "OPEN DATA DESK": "打开数据台",
  "IMPORT / DATA DESK": "导入 / 数据台", "Keep the archive recoverable.": "给整份档案留一份退路。", "This site stores personal ratings and notes in this browser. Export a copy before clearing site data or moving devices.": "你的评分和笔记只保存在这个浏览器里。清除网站资料或更换设备前，请先导出一份备份。", "LOCAL FOOTPRINT": "本地占用", "BROWSER QUOTA": "可用空间", "Checking…": "正在检查……", "DATA GROUPS": "资料类别", "RECOVERY POINTS": "恢复点", "LAST BACKUP": "最近一次备份", "Never": "从未备份", "BACKUP / RESTORE": "备份 / 恢复", "Move a versioned copy.": "导出或恢复一份带版本的副本。", "OPTIONAL BACKUP PASSWORD": "备份密码 / 可选", "At least 10 characters": "至少输入 10 个字符", "EXPORT PLAIN JSON": "导出可读 JSON", "EXPORT ENCRYPTED": "导出加密备份", "CHOOSE BACKUP TO RESTORE": "选择一份备份进行恢复", "REQUEST DURABLE STORAGE": "申请保留本地资料", "RECOVERY": "恢复记录", "Recent local changes.": "最近发生的本地变更。", "ROLL BACK LAST RESTORE": "撤销上一次恢复",
  ...
  "SAVE LABEL": "保存名称", "REMOVE SOURCE": "移除这个来源", "Import a public playlist once to create a local sync source.": "导入一次公开歌单后，这里会建立一个可同步的本地来源。", "No imported records yet.": "收件箱里还没有导入记录。",
