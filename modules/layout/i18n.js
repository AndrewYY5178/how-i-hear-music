...
const zh = {
  ...
  "ACCOUNT": "账号", "ACCOUNT / PRIVATE SYNC": "账号 / 私密同步", "Carry your archive with you.": "把这份档案带在身边", "No separate registration form. GitHub authorization creates the sync account; your private archive is encrypted with a different password that never leaves the browser.": "无需另填注册表。完成 GitHub 授权即会创建同步账号；私人档案使用另一组密码加密，这组密码不会离开浏览器。", "GitHub identifies this private sync account. Your music data remains in this browser until you choose an encrypted upload.": "GitHub 只负责识别这个私密同步账号；只有你主动选择上传加密副本，音乐资料才会离开此浏览器。", "GITHUB IDENTITY": "GITHUB 身份", "OPEN DATA DESK": "打开数据台", "REGISTER / SIGN IN WITH GITHUB": "注册 / 使用 GITHUB 登录", "Account sign-in is available on the published site.": "账号登录仅在已发布的网站中可用。", "Checking encrypted copy…": "正在检查加密副本……", "Registration and sign-in are handled securely by GitHub.": "注册与登录由 GitHub 安全处理。", "Close account panel": "关闭账号面板", "Could not sign out.": "无法退出登录。",
