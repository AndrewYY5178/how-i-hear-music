...
const zh = {
  ...
  "ACCOUNT": "账号", "ACCOUNT / PRIVATE SYNC": "账号 / 私密同步", "GitHub account.": "GitHub 账号", "Authorize GitHub once to create or enter a private sync account.": "完成一次 GitHub 授权，即可创建或进入私密同步账号。", "Private sync is ready in Data Desk.": "私密同步已在数据台准备就绪。", "GitHub identifies this private sync account. Your music data remains in this browser until you choose an encrypted upload.": "GitHub 只负责识别这个私密同步账号；只有你主动选择上传加密副本，音乐资料才会离开此浏览器。", "GITHUB IDENTITY": "GITHUB 身份", "OPEN DATA DESK": "打开数据台", "DATA DESK": "数据台", "REGISTER / SIGN IN WITH GITHUB": "注册 / 使用 GITHUB 登录", "Account sign-in is available on the published site.": "账号登录仅在已发布的网站中可用。", "Checking encrypted copy…": "正在检查加密副本……", "Registration and sign-in are handled securely by GitHub.": "注册与登录由 GitHub 安全处理。", "Close account panel": "关闭账号面板", "Could not sign out.": "无法退出登录。",
