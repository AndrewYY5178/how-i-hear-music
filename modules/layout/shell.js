...
export const renderShell = (path) => {
  ...
  header.innerHTML = `<a class="brand" href="${withBase("/")}" data-route>HIM <span>/</span> 001</a><button class="menu-toggle" type="button" aria-expanded="false" aria-controls="primary-nav">MENU</button><nav class="primary-nav" id="primary-nav">${nav.map(([href, label]) => link(href, label, path === href || (href !== "/" && path.startsWith(href)) ? "active" : "")).join("")}${link("/search", "Search", path === "/search" ? "utility-search active" : "utility-search")}</nav><div class="header-end">${link("/search", "SEARCH", path === "/search" ? "header-search active" : "header-search")}<span class="brand-mark">anddream</span><span class="edition mono">READ / 20—</span></div>`;
