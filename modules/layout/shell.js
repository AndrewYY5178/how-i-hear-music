...
const accountShell = () => {
  ...
  const nicknameForm = signedIn ? `<form class="account-nickname-form"><span class="mono account-nickname-label">NICKNAME</span><div class="account-nickname-row"><input name="nickname" aria-label="Nickname" value="${safe(nickname)}" maxlength="24" autocomplete="nickname" placeholder="How should this archive address you?" required><button class="text-action" type="submit">SAVE</button></div></form>` : "";
